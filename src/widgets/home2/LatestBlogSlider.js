            ...
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img1.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
          ...
          <div className="item">
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img2.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
          ...
          <div className="item">
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img5.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
          ...
          <div className="item">
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img7.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
          ...
          <div className="item">
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img8.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
          ...
          <div className="item">
            <div className="latest-post-item">
              <div className="latest-post-item-inner">
                <div className="latest-post-image">
                  <img
                    src={require(`../../assets/images/categories/new-fashion/post-img9.jpg`)}
                    className="img-fluid"
                    alt="post-img"
                  />
                </div>
