                  ...
                  <article className="post format-standard">
                          ...
                          <li>
                            <span className="author vcard">
                              <Link
                                className="url fn n"
                                to="#"
                                title="View all posts by CiyaShop"
                                rel="author"
                              >
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        stories, those modern-day legends surrounding the early
                        failures of such supremely successful folks as Michael
                        Jordan and Bill Gates. We can look a bit further back in
                        time to Albert Einstein or even further back to Abraham
                        Lincoln. what made each of these people so successful?
                        motivation. we know this in our gut, but what can we do
                        about it? how can we motivate ourselves? one of the most
                        difficult aspects of achieving success is staying
                        motivated over the long haul. motivation will almost
                        always beat mere talent.
                      </p>
                      <p className="mb-0">
                        Motivation is not an accident or something that someone
                        else can give you – you are the only one with the power
                        to motivate you. motivation cannot be an external force,
                        it must come from within as the natural product of your
                        desire to achieve something and your belief that you are
                        capable to succeed at your goal. positive
                        pleasure-oriented goals are much more powerful
                  ...
                  <nav className="navigation post-navigation" role="navigation">
                    ...
                    <div className="nav-links">
                      <div className="nav-previous">
                        <Link rel="prev">« Blog Post With Image Slider</Link>
                      </div>
                    </div>
                  </nav>
                  ...
                  <div className="comments-area">
                    <section className="respond-form">
                      <div className="comment-respond">
                        <h3 className="comment-reply-title text-blue">
                          Leave a Reply
                        </h3>
                        <form
                          action="#"
                        ...
                        >
                          ...
                          <div className="section-field comment-form-author">
                          ...
                          <div className="section-field comment-form-email">
                          ...
                          <div className="section-field comment-form-url">
                            <i className="fa fa-envelope-o">&nbsp;</i>
                            <Input
                              id="url"
                              name="url"
                          ...
                          <div className="section-field textarea comment-form-comment">
                          ...
                          <p className="form-submit">
                            <Input
                              ...
                              type="button"
                              id="submit"
                              className="submit button pull-left"
                              value="Post Comment"
                            />
                            <Input
                              type="hidden"
                    ...
                    <div className="recent-post">
                      <div className="recent-post-image">
                        <img
                          width="150"
                          height="150"
                          src={require(`../../assets/images/blog/recent-01.jpg`)}
                          className="img-fluid"
                          alt=""
                        />
                      </div>
                      <div className="recent-post-info">
                        ...
                        <span className="post-date">
                          <i className="fa fa-calendar"></i>August 14, 2017
                        </span>
                      </div>
                    </div>
                    {/* <div className="recent-post">
                  ...
                  <div className="widget widget_categories">
                    ...
                    <ul>
                      <li className="cat-item">
                        <Link className="" to="#">
                          <span className="widget_categories-post-title">
                            Clothing
                          </span>
                        </Link>
                        <span className="widget_categories-post-count">
                          (3)
                        </span>
                      </li>
                      <li className="cat-item">
