              ...
              <Row>
                <Col sm={12} md={12}>
                  <article className="post format-standard">
                    ...
                    <div className="entry-header-section">
                      ...
                      <div className="entry-title">
                        <h3 className="entry-title">
                          <Link to="/BlogSinglePage" rel="bookmark">
                          ...
                          <li>
                            <span className="author vcard">
                              <Link
                                className="url fn n"
                                href="#"
                                title="View all posts by Nova"
                                rel="author"
                              >
                                <i className="fa fa-user" /> Nova
                              </Link>
                            </span>
                          </li>
                          <li>
                            <span className="entry-meta-categories">
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        people who live this truth. we also know those epic
                        stories, those modern-day legends surrounding […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                        Read More
                      </Link>
                  ...
                  <article className="post format-gallery">
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        Why? so they then have a built-in excuse when things
                        don’t go their way! pretty sad situation, to say the
                        least. for those of you who are serious about […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                  ...
                  <article className="post format-quote">
                    <div className="blog-entry-quote">
                      <blockquote className="entry-quote">
                        ...
                        <p>
                          ...
                          spent in bodily personal attention.
                        </p>
                        <div className="quote-author text-right">- Nova </div>
                      </blockquote>
                    </div>
                    <div className="entry-header-section">
                      <div className="entry-meta-date">
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        step. we all know that nothing moves until someone makes
                        a decision. the first action is always in making the
                        decision to proceed. this is a fundamental step, which
                        most people overlook. without clarity, you send a very
                        garbled message out to the Universe. […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                  ...
                  <article className="post format-video">
                    <div className="blog-entry-you-tube">
                      <div className="embed-responsive embed-responsive-16by9">
                        <iframe
                          ...
                          src="https://www.youtube.com/embed/D2EvaSgi3UQ?rel=0"
                          allowFullScreen
                        />
                      </div>
                    </div>
                    ...
                    <div className="entry-content">
                      <p>
                        So, there you have it; the six steps that will help you
                        to the fabled land of achievement and success! You now
                        have the opportunity to push ahead and reach your
                        potential. No more excuses – make the commitment to take
                        action. Get the oars in the water and start rowing.
                        Execution is the single biggest […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                  ...
                  <article className="post format-audio">
                    ...
                    <div className="entry-content">
                      <p>
                        Focus is having the unwavering attention to complete
                        what you set out to do. There are a million distractions
                        in every facet of our lives. Telephones and e-mail,
                        clients and managers, spouses and kids, TV, newspapers
                        and radio – the distractions are everywhere and endless.
                        Everyone wants a piece of us and the result can […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                  ...
                  <article className="post format-video">
                    <div className="blog-entry-you-tube">
                      <div className="embed-responsive embed-responsive-16by9">
                        <iframe
                          className="embed-responsive-item"
                          src="https://player.vimeo.com/video/170272261?dnt=1&app_id=122963"
                          allowFullScreen
                        />
                      </div>
                    </div>
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        inflict on our children. So why do we do it? For the
                        most part, we don’t do it intentionally or with malice.
                        In the majority of cases, the cause is a well-meaning
                        but unskilled or un-thinking parent, who says the wrong
                        thing at the […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                  ...
                  <article className="post format-video">
                    <div className="blog-entry-html-video audio-video">
                      <video
                        poster={require(`../../assets/video/video-cover.jpg`)}
                        controls="controls"
                        preload="none"
                      >
                        <source
                          type="video/mp4"
                          src={require(`../../assets/video/Stock-Footage-of-Shopping-for-Womens-Clothing.mp4`)}
                        />
                        <source
                          type="video/webm"
                          src={require(`../../assets/video/Stock-Footage-of-Shopping-for-Women-s-Clothing_VP8.webm`)}
                        />
                        <source
                          type="video/ogg"
                          src={require(`../../assets/video/Stock-Footage-of-Shopping-for-Women-s-Clothing_libtheora.ogv`)}
                        />
                      </video>
                    </div>
                    <div className="entry-header-section">
                    ...
                    <div className="entry-content">
                      <p>
                        ...
                        want to have success. This is perhaps the single biggest
                        obstacle that all of us […]
                      </p>
                    </div>
                    <footer className="entry-footer clearfix">
                      <Link to="/BlogSinglePage" className="readmore">
                  ...
                  <Row>
                    <div className="navigation pagination clearfix col-lg-12 col-md-12 text-center"></div>
                  </Row>
                </Col>
              </Row>
            </Container>
